...
export const SERVICES = [
    ...
    gallery: [
      {
        ...
        alt: "Prewedding portrait of Ihsan and Ochi",
        width: 1200,
        height: 1800,
        meta: "Photo Prewedding",
        name: "Ihsan & Ochi",
      },
      {
        src: "img/pv-banda-neira.jpg",
        alt: "Banda Neira on stage",
        width: 1080,
        height: 1350,
        meta: "Stage Photography",
        name: "Banda Neira",
      },
      {
        src: "img/pv-stage.jpg",
        alt: "Stage performance photography",
        width: 1600,
        height: 2400,
        meta: "Stage Photography",
        name: "Rissau",
      ...
      {
        src: "img/pv-tsenja.jpg",
        alt: "Tsenja photoshoot",
        width: 1600,
        height: 2400,
        meta: "Photoshoot",
        name: "Tsenja",
      ...
      {
        src: "img/pv-ceremony.jpg",
        alt: "Ceremony photography",
        width: 1200,
        height: 1800,
        meta: "Photo & Video",
        name: "Titik Ngopi",
      ...
      {
        src: "img/vid-walimatul-ursy.jpg",
        alt: "Walimatul Ursy of Lia and Fenda",
        width: 1080,
        height: 1920,
        meta: "Video Documentation",
        name: "Walimatul Ursy, Lia & Fenda",
      },
      {
        src: "img/vid-walimatul-naqiah.jpg",
        alt: "Walimatul Naqiah ceremony",
        width: 1600,
        height: 2400,
        meta: "Video Documentation",
        name: "Walimatul Naqi'ah",
      },
      {
        src: "img/vid-graduation.jpg",
        alt: "Graduation live streaming",
        width: 1366,
        height: 2048,
        meta: "Live Streaming",
        name: "Wisuda, Batam",
    ...
    gallery: [
      {
        ...
        height: 1080,
        meta: "Product",
        name: "Studio product frame",
      },
      {
        src: "img/work-misc-1.jpg",
        alt: "Recent production still",
        width: 1080,
        height: 1350,
        meta: "Product",
        name: "Catalog frame, muted set",
      },
      {
        src: "img/work-misc-2.jpg",
        alt: "Recent production still",
        width: 1080,
        height: 1350,
        meta: "Product",
        name: "Catalog frame, warm set",
      },
      {
        src: "img/work-misc-3.jpg",
        alt: "Recent production still",
        width: 1080,
        height: 1350,
        meta: "Product",
        name: "Catalog frame, close crop",
      },
      {
        src: "img/about-cam.jpg",
        alt: "Camera gear ready for a shoot",
        width: 2400,
        height: 1600,
        meta: "Behind the scenes",
        name: "Kit checked before the call time",
      },
    ],
  },
  {
    ...
    gallery: [
      {
        ...
        alt: "Graphic design work for Double G",
        width: 1599,
        height: 2399,
        meta: "Graphic Design",
        name: "Double G",
      },
      {
        ...
        alt: "Behind the scenes during a production",
        width: 2399,
        height: 1756,
        meta: "Behind the scenes",
        name: "Layout pass on set",
      },
      {
        src: "img/about-set.jpg",
        alt: "Production set in progress",
        width: 2048,
        height: 1366,
        meta: "Behind the scenes",
        name: "Reviewing the day's frames",
      },
    ],
  },
  {
    ...
    gallery: [
      {
        ...
        height: 1756,
        meta: "Behind the scenes",
        name: "Shooting for the feed",
      },
      {
        src: "img/about-live.jpg",
        alt: "Live production in progress",
        width: 2400,
        height: 1600,
        meta: "Behind the scenes",
        name: "Capture day",
      },
      {
        ...
        alt: "Nava Creative crew on location",
        width: 2400,
        height: 1350,
        meta: "Behind the scenes",
        name: "Crew on location",
      },
      {
        src: "img/about-cam.jpg",
        alt: "Camera gear ready for a shoot",
  ...
  },
  {
    ...
    gallery: [
      ...
      {
        src: "img/vid-livestream.jpg",
        alt: "Live streaming setup during an event",
        width: 2400,
        height: 1600,
        meta: "Live Streaming",
        name: "On air",
