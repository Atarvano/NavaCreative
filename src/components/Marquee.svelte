<script>
  ...
  // Constant drift (track quadrupled like legacy) with a scroll-velocity
...
<!-- Marquee: service ticker. 1:1 with legacy/index.html markup (JS quadruples the track like legacy). -->
